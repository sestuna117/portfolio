  ...
  return (
    <div className="content-page">
      ...
      <div className="content-body">
        <p>
          I am currently enrolled as a senior at Stony Brook University studying
          the Computer Science major. I am passionate about web-development and
          love learning new technologies to further improve my skills.
        </p>
        <p>
